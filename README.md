...
Proyek ini dapat dijalankan melalui terminal dari *root folder* proyek (folder `countingcost`).
...
**Momen “Aha!” Terbesar:**
> Momen "klik" terbesar saya adalah saat kami diskusi soal *code smell* "Feature Envy" pada `PCReportGenerator`. Setelah kami pindahkan *method*-nya ke *class* `PC`, desainnya jadi jauh lebih logis. Momen "aha" lainnya adalah soal realitas proyek. Awalnya kami sangat ingin pakai JFrame untuk GUI, tapi setelah melihat beban kerja, kami sadar waktunya tidak akan cukup. Ini jadi pelajaran
